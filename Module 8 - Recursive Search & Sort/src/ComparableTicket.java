...
public class ComparableTicket implements Comparable<ComparableTicket>
{
    ...
    /**
     * Compares this instance of ticket with another instance based on their respective ticket id numbers. (Provides the compareTo() method required by the Comparable interface)
